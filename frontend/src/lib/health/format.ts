...
export function getZScoreColor(z: number | null): string {
  ...
  if (z >= 0.5) return "text-green-700 dark:text-green-700";
  if (z <= -1) return "text-red-700 dark:text-red-400";
  if (z <= -0.5) return "text-orange-700 dark:text-orange-400";
...
export function getHealthScoreColor(score: number | null): string {
  ...
  if (score >= 0.5) return "text-green-700 dark:text-green-700";
  if (score >= -0.5) return "text-blue-700 dark:text-blue-400";
  if (score >= -1.5) return "text-orange-700 dark:text-orange-400";
