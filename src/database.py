...
def init_db() -> None:
    try:
        logger.info("Database managed by Alembic - no direct table creation")
        logger.info("Use 'flask db upgrade head' to apply migrations")
        logger.info("✅ Database initialization ready (Alembic)")
